 ...
 **/
public class JedisEvalTest {

    public static final Logger logger = LoggerFactory.getLogger(JedisEvalTest.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Object ret = jedis.eval("return redis.call('get',KEYS[1])", 1, "hello");
